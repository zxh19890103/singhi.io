...
{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-01-langs09-768x469.png" title="高级语言和 assembly 语言之间的关系，中间存在一个 IR 语言" %}
...
{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-02-langs08-768x501.png" title="webassembly 应该放到 IR 和 assembly 之间吧" %}
...
{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-03-toolchain07-768x631.png" title="编译工具链" %}
...
{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-04-memory04-768x143.png" title="js 调用 c  的函数，传入了一个数字，c 函数返回了一个整数" %}
...
{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-05-memory12-768x614.png" title="js 调用了 c 函数，传入了一个整数，作为内存指针，然后 c 会将其写入内存" %}
...
{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-06-hex_binary_asm01-768x391.png" title="3 段指令，分别以 16 进制、二进制、文本呈现 " %}

#### 代码是如何工作的：一个栈机

按照你的意愿，相关的指令如下：

{% include img.html src="https://hacks.mozilla.org/files/2017/02/04-07-hex_binary_asm02-768x269.png" title="get_local 0 从第一个参数获得值，并压入栈。i32.const 42 则将一个常数压栈。i32.add 则对栈首的两个值进行了加法运算，并压入结果" %}
