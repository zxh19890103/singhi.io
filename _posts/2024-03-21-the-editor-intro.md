...
layout: post
title: 仓库编辑器介绍
short: 简要介绍一下我海柔创新设计和开发的仓库编辑器项目
category: tech
---
...
我们在开发[监控系统](./the-realtime-monitor-intro)的时候，尝试过使用 [X6](https://x6.antv.antgroup.com/)，考虑过 [FabricJs](https://fabricjs.com/)，X6 采取 SVG 渲染，极不适合渲染成规模的图形元素，这是做过试验的，大概超过 **3000** 个点（最简单的图形）渲染就会表现得吃力，在后期的交互上更是不堪。
