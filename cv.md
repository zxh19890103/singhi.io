...
拥有 10 年软件开发经验，其中 8 年专注于前端技术，精通 `React、Vue、ThreeJs、NodeJs、WebGL、TypeScript、ES6` 等主流前端框架和技术，擅长面向*对象编程*（OOP）和*架构设计*。熟悉领域驱动设计（DDD）在前端的实践，能够将 DDD 思维运用到业务逻辑建模和状态管理。
