...
拥有 10 年软件开发经验，其中 8 年专注于前端技术，精通主流前端框架和技术，擅长面向对象编程（OOP）和架构设计。熟悉领域驱动设计（DDD）在前端应用中的实践，能够将 DDD 思维运用到业务逻辑建模和状态管理。

过去 3 年在海柔创新科技担任高级前端工程师，参与开发了仓库布局系统（编辑器）、仓库图形库和实时监控系统。在图形化技术和大规模系统架构的设计与实现方面积累了丰富的经验。
